...
export default class extends Controller {
  static targets = ["modal", "confirmButton", "summaryName", "summaryPurpose", "summaryItemCount"]
  ...
  open(event) {
    ...
    const purpose = this.form.querySelector("[name='client_checkout[purpose]']")?.value.trim() || ""
    ...
    this.summaryPurposeTarget.textContent = purpose || "—"
